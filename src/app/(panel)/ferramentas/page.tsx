...
const tools = [
  ...
  {
    href: '/ferramentas/flow-builder',
    title: 'Flow Builder',
    description: 'Crie fluxos visuais de atendimento com arrastar e soltar. Conecte agentes de IA, condições e respostas automáticas para o WhatsApp.',
    badge: 'Disponível',
    steps: ['Criar fluxo', 'Adicionar blocos', 'Salvar e ativar'],
    icon: (
      <svg width="28" height="28" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.6}
